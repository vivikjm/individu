...
function Header()
{
    ...
    $this->Cell(30,10,'KJM Elektronik');

    $this->Ln(10);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'Pagedongan, Banjarnegara');

    $this->cell(80);
    $this->SetFont('Arial','',10);
    $this->cell(30,10,'Banjarnegara, '.base64_decode($_GET['uuid']).'');
    $this->Line(10,40,200,40);

    $this->Ln(5);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'Telp : 081344284170');
    $this->Line(10,40,200,40);
...
$pdf->Output('','KJM_Elektronik/'.$filename.'.pdf');
?>
