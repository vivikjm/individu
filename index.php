...
<html>
<head>
	<title>Login | KJM Elektronik</title>
	<style type="text/css">
	@font-face{
	...
	100%{opacity: 1;}
		...
		.both{clear: both;}
		.loginpage{position: fixed;background:url("assets/img/2016-12-04 09.12.39 1.jpg");height: 100%;width: 100%;background-size: 100%;}
